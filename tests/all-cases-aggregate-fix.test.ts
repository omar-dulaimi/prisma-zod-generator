...
model user_profile {
  ...
  it(
    'capitalizes AggregateArgs Prisma type names across model naming styles',
    async () => {
      const scenarios = [
        { modelName: 'user', expectedAggregateArgs: 'UserAggregateArgs' },
        {
          modelName: 'userSession',
          expectedAggregateArgs: 'UserSessionAggregateArgs',
        },
        {
          modelName: 'doc_parser_agent',
          expectedAggregateArgs: 'Doc_parser_agentAggregateArgs',
        },
        { modelName: 'User', expectedAggregateArgs: 'UserAggregateArgs' },
      ];
