...
describe('Configuration System Tests', () => {
  describe('Configuration File Parsing', () => {
    it('should parse valid JSON configuration files', async () => {
  ...
  describe('Configuration Validation', () => {
    ...
    it('should handle model validation with model names', async () => {
  ...
  describe('Default Configuration', () => {
    ...
    it('should merge with defaults during validation', async () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle parse errors gracefully', async () => {
      ...
      try {
        ...
        const { createConfigErrorMessage, ConfigParseError } = await import('../src/config/parser');
  ...
  describe('Configuration Discovery', () => {
    it('should discover configuration files in standard locations', async () => {
  ...
  describe('Configuration Integration', () => {
    it('should work in generation context', async () => {
