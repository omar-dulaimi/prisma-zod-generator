...
describe('Filtering Logic Tests', () => {
  describe('Model-Level Filtering', () => {
    it('should enable/disable entire models based on configuration', async () => {
    ...
    it('should handle model filtering with relationships', async () => {
    ...
    it('should generate index files excluding disabled models', async () => {
  ...
  describe('Operation-Level Filtering', () => {
    it('should control which CRUD operations are generated per model', async () => {
      ...
      try {
        ...
        userDisallowedFiles.forEach(file => {
          expect(existsSync(file), `User disallowed operation should NOT exist: ${file}`).toBe(false);
        });
        ...
        postDisallowedFiles.forEach(file => {
          expect(existsSync(file), `Post disallowed operation should NOT exist: ${file}`).toBe(false);
        });
    ...
    it('should handle aggregate operations filtering', async () => {
    ...
    it('should validate operation names against allowed operations', async () => {
  ...
  describe('Field-Level Filtering', () => {
    it('should exclude specific fields from generated schemas', async () => {
...
`;
    ...
    it('should preserve field relationships and imports when filtering', async () => {
...
`;
  ...
  describe('Complex Filtering Scenarios', () => {
    it('should handle combinations of model, operation, and field filtering', async () => {
    ...
    it('should handle wildcard and pattern-based filtering', async () => {
...
`;
    ...
    it('should validate filter configurations for conflicts', async () => {
