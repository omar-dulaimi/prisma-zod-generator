...
describe('Basic Integration Tests', () => {
  describe('Configuration Integration', () => {
    it('should parse and validate configuration with all features', async () => {
    ...
    it('should handle configuration with model validation', async () => {
  ...
  describe('Schema Generation Integration', () => {
    it('should create proper test schemas', async () => {
  ...
  describe('Configuration Generator Integration', () => {
    it('should generate various configuration types', async () => {
  ...
  describe('Error Handling Integration', () => {
    ...
    it('should handle validation errors with helpful messages', async () => {
      ...
      try {
        ...
        const { validateConfiguration, formatValidationErrors } = await import('../src/config/validator');
  ...
  describe('Feature Compatibility', () => {
    it('should validate configuration with multiple features enabled', async () => {
    ...
    it('should handle configuration discovery and defaults', async () => {
  ...
  describe('Test Infrastructure Integration', () => {
    it('should provide consistent test utilities', async () => {
