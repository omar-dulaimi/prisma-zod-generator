...
const testImportedSchemas = async () => {
  ...
  try {
    ...
    const findFirstMongoUser = await import('../prisma/schemas/mongodb/generated/schemas/findFirstMongoUser.schema');
    results.push({ name: 'findFirstMongoUser', success: true, schema: findFirstMongoUser.MongoUserFindFirstSchema });
    
    const findManyMongoUser = await import('../prisma/schemas/mongodb/generated/schemas/findManyMongoUser.schema');
    results.push({ name: 'findManyMongoUser', success: true, schema: findManyMongoUser.MongoUserFindManySchema });
    
    const createOneMongoUser = await import('../prisma/schemas/mongodb/generated/schemas/createOneMongoUser.schema');
    results.push({ name: 'createOneMongoUser', success: true, schema: createOneMongoUser.MongoUserCreateOneSchema });
    
    const updateOneMongoUser = await import('../prisma/schemas/mongodb/generated/schemas/updateOneMongoUser.schema');
    results.push({ name: 'updateOneMongoUser', success: true, schema: updateOneMongoUser.MongoUserUpdateOneSchema });
    
    const deleteOneMongoUser = await import('../prisma/schemas/mongodb/generated/schemas/deleteOneMongoUser.schema');
    results.push({ name: 'deleteOneMongoUser', success: true, schema: deleteOneMongoUser.MongoUserDeleteOneSchema });
    
    // Test aggregate schemas
    const aggregateMongoUser = await import('../prisma/schemas/mongodb/generated/schemas/aggregateMongoUser.schema');
    results.push({ name: 'aggregateMongoUser', success: true, schema: aggregateMongoUser.MongoUserAggregateSchema });
    
    // Test enum schemas
    const sortOrder = await import('../prisma/schemas/mongodb/generated/schemas/enums/SortOrder.schema');
    results.push({ name: 'SortOrder', success: true, schema: sortOrder.SortOrderSchema });
    
    const mongoUserScalarFieldEnum = await import('../prisma/schemas/mongodb/generated/schemas/enums/MongoUserScalarFieldEnum.schema');
    results.push({ name: 'MongoUserScalarFieldEnum', success: true, schema: mongoUserScalarFieldEnum.MongoUserScalarFieldEnumSchema });
    
    // Test object schemas
    const mongoUserWhereInput = await import('../prisma/schemas/mongodb/generated/schemas/objects/MongoUserWhereInput.schema');
    results.push({ name: 'MongoUserWhereInput', success: true, schema: mongoUserWhereInput.MongoUserWhereInputObjectSchema });
    
    const mongoUserCreateInput = await import('../prisma/schemas/mongodb/generated/schemas/objects/MongoUserCreateInput.schema');
    results.push({ name: 'MongoUserCreateInput', success: true, schema: mongoUserCreateInput.MongoUserCreateInputObjectSchema });
    
    const mongoUserUpdateInput = await import('../prisma/schemas/mongodb/generated/schemas/objects/MongoUserUpdateInput.schema');
    results.push({ name: 'MongoUserUpdateInput', success: true, schema: mongoUserUpdateInput.MongoUserUpdateInputObjectSchema });
    
    const stringFilter = await import('../prisma/schemas/mongodb/generated/schemas/objects/StringFilter.schema');
    results.push({ name: 'StringFilter', success: true, schema: stringFilter.StringFilterObjectSchema });
