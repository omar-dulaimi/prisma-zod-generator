...
describe('Result Schema Generation Tests', () => {
  describe('Single Model Result Schemas', () => {
    it('should generate result schemas for operations that return single model instances', async () => {
      ...
      try {
        ...
        expectedSingleResults.forEach(resultFile => {
          ...
          expect(existsSync(filePath), `Single result schema should exist: ${resultFile}`).toBe(true);
    ...
    it('should handle nullable results for operations that might return null', async () => {
  ...
  describe('Array Result Schemas for FindMany Operations', () => {
    it('should generate array result schemas for findMany operations', async () => {
      ...
      try {
        ...
        const findManyResults = [
          'UserFindManyResult.schema.ts',
          'PostFindManyResult.schema.ts'
        ];

        findManyResults.forEach(resultFile => {
          const filePath = join(resultsDir, resultFile);
          expect(existsSync(filePath), `FindMany result schema should exist: ${resultFile}`).toBe(true);
    ...
    it('should handle pagination metadata in findMany results', async () => {
      ...
      try {
        ...
        if (existsSync(userFindManyResultPath)) {
          ...
          if (content.includes('count') || content.includes('total') || content.includes('meta')) {
  ...
  describe('Aggregate and GroupBy Result Schemas', () => {
    it('should generate result schemas for aggregate operations', async () => {
...
`;
    ...
    it('should generate result schemas for groupBy operations with dynamic fields', async () => {
...
`;
    ...
    it('should handle complex aggregate operations with multiple field types', async () => {
...
`;
        ...
        const analyticsAggregateResultPath = join(resultsDir, 'AnalyticsAggregateResult.schema.ts');
  ...
  describe('Count Operation Result Schemas', () => {
    it('should generate result schemas for simple count operations', async () => {
      ...
      try {
        ...
        const countResults = [
          'UserCountResult.schema.ts',
          'PostCountResult.schema.ts'
        ];
    ...
    it('should handle count operations with relation filters', async () => {
  ...
  describe('Result Schema Integration with Main Transformer', () => {
    it('should integrate result schemas with main transformer and file generation', async () => {
      ...
      try {
        ...
        const operationFiles = FileSystemUtils.getSchemaFiles(schemasDir)
          .filter(file => !file.includes('/results/') && !file.includes('/objects/') && !file.includes('/enums/'));
    ...
    it('should handle imports and dependencies correctly', async () => {
...
`;
  ...
  describe('Result Schema Variations and Options', () => {
    it('should generate different result schemas based on include/select options', async () => {
    ...
    it('should handle result schemas with field exclusions', async () => {
...
`;
    ...
    it('should integrate with variant configurations', async () => {
