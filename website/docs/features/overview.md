...
The core generator emits Zod schemas. These packs generate the layers teams usually hand-write around
them — forms, server actions, SDKs, API docs, access policies, contract tests and CI guards — from the
same Prisma schema.
