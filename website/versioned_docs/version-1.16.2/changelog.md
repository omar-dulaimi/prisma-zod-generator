...
:::tip Latest Release
The latest version is **v1.16.2**. See the [GitHub Releases](https://github.com/omar-dulaimi/prisma-zod-generator/releases) page for downloads and detailed release notes.
:::
...
- **Current:** v1.16.x - Full support with new features and bug fixes
